...
const production = [
  ...
  '!src/pages/**/_*{.astro}', // negate files prefixed with _.
  '!src/pages/**/_*/**{.astro}', // negate folders prefixed with _. The pattern _** would be collapsed into _* so we have to use **/_*/**
  'src/content/**/*.mdx',
